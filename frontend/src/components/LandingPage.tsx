      ...
      <footer className="bg-gray-900 dark:bg-black text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center text-gray-400">
            <p className="text-lg">© 2025 NoteSpace. Your privacy is our priority.</p>
            <p className="mt-2">Built with Aakash for privacy-conscious individuals worldwide.</p>
          </div>
        </div>
      </footer>
